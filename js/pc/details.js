...
//	})
	...
	$(".smallPic").click(function(){
		var url = $(this)[0].src;
		$("#show_pic")[0].src = url;
		$(".smallPic").css("borderColor","#dbdbdb");
		$(this).css("borderColor","#129700");
	})
	
	/////////增加商户选择
	$(window).load(function(){
		var selectContent = $(".selectCon").eq(0).html();
		$("#beSelect").html(selectContent);
	})
	$("#customerSelect").click(function(){
		$("#selectAll").fadeToggle(300);
		$(".selectAll").click(function(){
			var selectContent = $(this).find(".selectCon").html();
			$("#beSelect").html(selectContent);
	...
	$("#plus").click(function(){
		var value = $(this).parent().siblings(".product_number").val();
		value++;
		$(this).parent().siblings(".product_number").val(value);
	})
