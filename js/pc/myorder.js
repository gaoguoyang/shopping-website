$(document).ready(function(){
	...
	$(".evaluate").click(function(){
		...
		$(".evaluateContent .pingfen img").click(function(){
			rank = $(this).index();
			rank++;

			$(".evaluateContent .pingfen img").each(function(){
				$(this).attr("src","../images/web/myorder/star_gray_07.png") ;
			})
			for( var i=0; i<rank-1; i++){
				$(this).parent().find("img").eq(i).attr("src","../images/web/myorder/star_06.png") ;
			}
		})
		$(".complete").click(function(){
			var textValue = $("#inputPing").val().length;
			if(textValue == 0){
				alert("请输入评价");
			}
			else {
				...
				// $("#inputPing").val("");
				for( var i=0; i<5; i++){
					$(".pingfen").find("img").eq(i).attr("src","../images/web/myorder/star_gray_07.png") ;
				}
